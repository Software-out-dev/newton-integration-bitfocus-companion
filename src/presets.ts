...
export function getPresetDefinitions(): CompanionPresetDefinitions {
	...
	// ===== Snapshots =====
	// Select the snapshot once in the action; the feedback follows that selection.
	presets['snapshot_apply'] = {
		...
		steps: [
			{
				down: [{ actionId: 'snapshot_apply_selected', options: { uuid: '', fadingTime: 2000, mode: 'Direct' } }],
				up: [],
			},
		],
		feedbacks: [{ feedbackId: 'snapshot_action_label', options: {} }],
	}
